...
val make_in_channel : ?close:(unit -> unit Lwt.t) ->
  (Bytes.t -> int -> int -> int Lwt.t) -> in_channel
...
val input : in_channel -> Bytes.t -> int -> int -> int Lwt.t
val really_input : in_channel -> Bytes.t -> int -> int -> unit Lwt.t
val input_char : in_channel -> char Lwt.t
val input_binary_int : in_channel -> int Lwt.t

val open_in_gen : Uwt.Fs.uv_open_flag list -> int -> string -> in_channel Lwt.t
...
(* val out_channel_of_descr : Uwt_unix.file_descr -> out_channel *)

val make_out_channel : ?close:(unit -> unit Lwt.t) ->
  (Bytes.t -> int -> int -> int Lwt.t) -> out_channel
...
val output : out_channel -> Bytes.t -> int -> int -> unit Lwt.t
...
val open_out_gen : Uwt.Fs.uv_open_flag list -> int -> string -> out_channel Lwt.t
val open_out : string -> out_channel Lwt.t
val close_out : out_channel -> unit Lwt.t

val open_connection : Uwt.sockaddr -> (in_channel * out_channel) Lwt.t
